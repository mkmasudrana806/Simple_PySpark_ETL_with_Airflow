...
with DAG(
    ...
    transform_data = BashOperator(
        ...
        bash_command="python /opt/airflow/spark/jobs/transform.py"
    )
    
    
    gold_load = BashOperator(
        task_id="gold_aggregations",
        bash_command="python /opt/airflow/spark/jobs/gold_load.py"
    )
    ...
    (
        [
            ...
            create_top_product_summary,
            create_discount_effectiveness,
        ]
        >> extract_data
        >> transform_data
        >> gold_load
